...
These integrations are gated behind extras (`pip install vibatchium[stealth-mouse]`,
etc.) because they pull in deps that aren't on PyPI (CDP-Patches) or have
licensing wrinkles. Vibatchium's base stealth (Patchright's Runtime.enable patch,
...
Usage from CLI:
    vibatchium start --stealth-mouse   # humanize mouse trajectories
